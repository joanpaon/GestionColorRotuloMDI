...
public class Controller {
    ...
    public void sincronizarModeloVista(Model model, View view) {
        ...
        view.lblFrente.setBackground(new Color(frenteR, frenteV, frenteA));
        ...
        view.lblFondo.setBackground(new Color(fondoR, fondoV, fondoA));
        
        // Análisis Frente/Fondo
...
//        sincronizarModeloVista(model, view);
    ...
    public void procesarColor(ChangeEvent evt) {
        // Control > Modelo
        if (view.rbtFrente.isSelected()) {
    ...
    public void procesarFrenteFondo(ActionEvent evt) {
        // Modelo > Vista
        sincronizarModeloVista(model, view);
    }
}
